...
![Установка системы](datasets/Part_1.png "Установка системы")
...
![Создан новый пользователь keller](datasets/Part_2-1.png "Создан новый пользователь keller")

[Создание пользователя с помощью утилиты `adduser` и добавление в группу adm командой `usermode -a -G adm`]

+ **Проверка пользователей**

![Вывод команды cat /etc/passwd](datasets/Part_2-2.png "Вывод команды cat /etc/passwd")
...
![Просмотр внешнего ip-адреса](datasets/Part_3-5.png "Просмотр внешнего ip-адреса")

![Просмотр ip-адресов шлюза](datasets/Part_3-6.png "Просмотр ip-адресов шлюза")
...
![Меняем файл Netplan](datasets/Part_4-1.png "Меняем файл Netplan")

![Файл до изменений](datasets/Part_4-2.png "Файл до изменений")

[Файл до изменений]

![Файл после изменений](datasets/Part_4-3.png "Файл после изменений")

[Файл после изменений]

![Сохраняем изменения](datasets/Part_4-4.png "Сохраняем изменения")

+ **Проверка адреса интерфейса после перезагрузки**

![Проверяем адрес интерфейса](datasets/Part_4-5.png "Проверяем адрес интерфейса")

![ip route](datasets/Part_4-6.png "ip route")

![Проверяем DNS](datasets/Part_4-7.png "Проверяем DNS")
...
![Пингуем 1.1.1.1](datasets/Part_4-8.png "Пингуем 1.1.1.1")

![Пингуем ya.ru](datasets/Part_4-9.png "Пингуем ya.ru")
...
sudo apt upgrade
```
![Обновление пакетов](datasets/Part_5-1.png "Обновление пакетов")
...
```
![Предоставление прав sudo](datasets/Part_5-2.png "Предоставление прав sudo пользователю и изменение имени устройства")
...
```
![Синхронизация времени](datasets/Part_6.png "Синхронизация времени")
...
```
![delmerfi vim](datasets/Part_7-1.png "delmerfi vim")
...
![delmerfi nano](datasets/Part_7-2.png "delmerfi nano")
...
![delmerfi mcedit](datasets/Part_7-3.png "delmerfi mcedit")
...
![21 School 21 vim](datasets/Part_7-4.png "21 School 21 vim")
...
![21 School 21 nano](datasets/Part_7-5.png "21 School 21 nano")

**Mcedit: F10**

**Save file?: No**

![21 School 21 mcedit](datasets/Part_7-6.png "21 School 21 mcedit")
...
/School
```
![vim search](datasets/Part_7-7.png "vim search")
...
:s/School/Test/
```
![vim replace](datasets/Part_7-8.png "vim replace")
...
![nano search](datasets/Part_7-9.png "nano search")
...
![nano replace 1](datasets/Part_7-10.1.png "nano replace 1")

![nano replace 2](datasets/Part_7-10.2.png "nano replace 2")

![nano replace result](datasets/Part_7-10.3.png "nano replace result")
...
![mcedit search](datasets/Part_7-11.1.png "mcedit search")

![mcedit search result](datasets/Part_7-11.2.png "mcedit search result")
...
![mcedit replace](datasets/Part_7-12.1.png "mcedit replace")

![mcedit replace result](datasets/Part_7-12.2.png "mcedit replace result")
...
![Вывод команды ps](datasets/Part_8-1.png "Вывод команды ps")
...
![Вывод команды netstat -tan](datasets/Part_8-2.png "Вывод команды netstat -tan")
...
![Вывод команды top](datasets/Part_9-1.png "Вывод команды top")
...
![Сортировка вывода команды htop по PID](datasets/Part_9-2.1.png "Сортировка вывода команды htop по PID")

[Сортировка вывода команды `htop` по PID]

![Сортировка вывода команды htop по PERSENT_CPU](datasets/Part_9-2.2.png "Сортировка вывода команды htop по PERSENT_CPU")

[Сортировка вывода команды `htop` по PERSENT_CPU]

![Сортировка вывода команды htop по PERSENT_MEM](datasets/Part_9-2.3.png "Сортировка вывода команды htop по PERSENT_MEM")

[Сортировка вывода команды `htop` по PERSENT_MEM]

![Сортировка вывода команды htop по времени](datasets/Part_9-2.4.png "Сортировка вывода команды htop по времени")

[Сортировка вывода команды `htop` по времени]

+ **F4 - отфильтровать sshd-процесс:**

![Фильтр для sshd-процесса](datasets/Part_9-3.png "Фильтр для sshd-процесса")

[Фильтр для sshd-процесса]

+ **F3 - поиск процесса syslog:**

![Поиск процесса по запросу syslog](datasets/Part_9-4.png "Поиск процесса по запросу syslog")

[Поиск процесса по запросу syslog]

+ **F2 - изменим интерфейс. Добавим вывод hostname и time, кастомизируем вывод uptime:**

![Вывод hostname, clock, uptime](datasets/Part_9-5.png "Вывод hostname, clock, uptime")
...
![Вывод fdisk](datasets/Part_10.png "Вывод fdisk")
...
![Вывод df](datasets/Part_11-1.png "Вывод df")
...
![Вывод df -Th](datasets/Part_11-2.png "Вывод df -Th")
...
![Вывод du](datasets/Part_12-1.png "Вывод du")
...
![Вывод du с флагами](datasets/Part_12-2.png "Вывод du с флагами")
...
![Вывод du с *](datasets/Part_12-3.png "Вывод du с *")
...
![Вывод du с -ha](datasets/Part_12-4.1.png "Вывод du с -ha")

![Вывод du с -ha](datasets/Part_12-4.2.png "Вывод du с -ha")
...
![Вывод ncdu /home](datasets/Part_13-1.png "Вывод ncdu /home")
...
![Вывод ncdu /var](datasets/Part_13-2.png "Вывод ncdu /var")

![Вывод ncdu /var/log](datasets/Part_13-3.png "Вывод ncdu /var/log")
...
![Вывод du](datasets/Part_13-4.png "Вывод du")
...
![Вход в систему](datasets/Part_14-1.png "Вход в систему")
...
![Информация о рестарте службы sshd](datasets/Part_14-2.png "Информация о рестарте службы sshd")
...
![Информация из логов о работе cron](datasets/Part_15-1.png "Информация из логов о работе cron")
...
![Вывод crontab -l](datasets/Part_15-2.png "Вывод crontab -l")
...
crontab -l
```
![Вывод crontab -l после удаления всех задач](datasets/Part_15-3.png "Вывод crontab -l после удаления всех задач")
